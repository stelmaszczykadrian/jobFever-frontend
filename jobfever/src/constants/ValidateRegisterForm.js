...
export const minimumNameLengthMessage = 2
export const minimumPasswordLength = 6;
export const incorrectEmailAddressMessage = 'Invalid email address.';
export const incorrectEmailEmptyMessage = 'Email field cannot be empty.';
